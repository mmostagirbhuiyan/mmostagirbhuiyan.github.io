...
const ProjectCard = ({
  ...
  <a
    ...
    target="_blank"
    rel="noreferrer"
    className="card glass-bg p-6 h-full flex flex-col justify-between group no-underline text-base-content"
  >
    <div>
      <div className="flex justify-between items-start mb-4">
        ...
        <FaExternalLinkAlt className="text-base-content/50 group-hover:text-base-content transition-colors" size={14} />
      </div>
      <div className="text-base-content/70 text-sm leading-relaxed mb-4">
        {description}
      </div>
    </div>

    {/* Decorative gradient line at the bottom */}
    <div className="w-full h-1 bg-gradient-to-r from-primary to-secondary opacity-30 rounded-full group-hover:opacity-100 transition-opacity duration-500" />
  </a>
);
